...
import 'Nexi_payment_second_page.dart';


class NexyPayment extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => NexyPaymentState();
}

class NexyPaymentState extends State<NexyPayment> {
          ...
          child: Column(
            ...
            ElevatedButton(
                ...
                onPressed: () => Navigator.push<Widget>(
                      context,
                      MaterialPageRoute(
                        builder: (context) => NexiSecondPage(),
                      ),
                    )),
          ])),
    );
